...
class LoginInstructor extends Component {
  constructor() {
    super();
    this.state = {
      email: "",
  ...
  onSubmit(e) {
    ...
    this.props.loginInstructor(newInstructor);
  }
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <div className="card-body">
                  ...
                  <h4 className="mb-3 f-w-400">Login into your Instructor account</h4>
                  ...
                  <p className="mb-0 text-muted">
                    ...
                    <a
                      href={`${process.env.PUBLIC_URL}/register/instructor`}
                      className="f-w-400"
                    >
