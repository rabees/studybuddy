...
export default class CatEdit extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://studybuddypakistan.herokuapp.com/category?id=" + this.props.match.params.id)
      .then(response => {
  ...
  onSubmit = e => {
    ...
    axios
      .put("https://studybuddypakistan.herokuapp.com/category?id=" + this.props.match.params.id, {
        no,
        categoryName
      })
      .then(result => {
