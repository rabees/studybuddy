  ...
  const onSubmit = (event) => {
    ...
    if (name && email && phone) {
      bookAppointment({ name, email, phone, slots })
        ...
        .catch((error) => {
          console.log("Error in booking the slot.", error);
        });
    } else {
      setValues({
        ...values,
            ...
            <div className="col-md-6 mt-5 mx-auto text-center">
              ...
              <div className="form-group text-left">
                <form>
                  ...
                  <button
                    onClick={onSubmit}
                    className="my-3 form-control btn btn-primary btn-block"
                  >
                    Submit
                  </button>
                </form>
        ...
        <div className="row">
          <div className="col-md-6 offset-sm-3 text-left">
            <div className="alert alert-success">
              Your slot has been booked. Please reach on the desired time.
            </div>
          </div>
        </div>
      );
