...
class HeroSliderOne extends Component{
    ...
    render(){
        ...
        let data = [
            {
                bgImg: 'slider3.jpg', 
                sliderTitle: "Learn with Like Minded People",
                sliderSubtitle: "Find your perfect study buddy and start learning.",
                btnLink: "contact-us"
            },
            {
                bgImg: 'slider2.jpg', 
                sliderTitle: "Connect With People",
                sliderSubtitle: "Social forum that connects people.",
                btnLink: "contact-us"
            },
            {   
                bgImg: 'slider1.jpg', 
                sliderTitle: "Build Your Career",
                sliderSubtitle: "Start your part-time job at Study Buddy.",
                btnLink: "contact-us"
            }
        ];
                        ...
                        <div className="hero-slider__content-wrapper">
                            ...
                            <div className="row">
                                ...
                                <div className="hero-slider__content">
                                    ...
                                    <a className="hero-slider__btn" href={`${process.env.PUBLIC_URL}/login/student`}> GET STARTED</a>
                                </div>
                                </div>
                            </div>
                            </div>
